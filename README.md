...
3. Click on the **Import** tab then select the provided ***shifa_db.sql file*** from the project folder and **click Go**.
...
To demonstrate the **Update and Delete** logic for the administrator: 
